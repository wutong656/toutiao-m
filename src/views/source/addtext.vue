          ...
          <el-form ref="form" :model="form" label-width="100px" label-position="left">
            ...
            <div class="tabs">
              <el-upload
                ...
                >
                <span class="f-c-1890ff" v-show="fileList.length>0">更改封面图</span>
                <span class="f-c-1890ff" v-show="fileList.length<1">添加封面图</span>
              </el-upload>
              <div class="tip" v-show="fileList.length<1">建议尺寸:1068*455</div>
            </div>
